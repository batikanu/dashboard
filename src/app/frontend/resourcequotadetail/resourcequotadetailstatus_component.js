...
const i18n = {
  /** @export {string} @desc Resource quota details status section resource name. */
  MSG_RESOURCE_QUOTA_STATUS_RESOURCE_NAME: goog.getMsg('Resource Name'),
  /** @export {string} @desc Resource quota details status section hard. */
  MSG_RESOURCE_QUOTA_STATUS_HARD: goog.getMsg('Hard'),
  /** @export {string} @desc Resource quota details status section used. */
  MSG_RESOURCE_QUOTA_STATUS_USED: goog.getMsg('Used'),
};
