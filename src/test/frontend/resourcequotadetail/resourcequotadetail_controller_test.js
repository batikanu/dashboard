...
import {ResourceQuotaDetailController} from 'resourcequotadetail/resourcequotadetail_controller';
...
describe('Resource Quota Detail controller', () => {
  ...
  it('should initialize resource quota controller', angular.mock.inject(($controller) => {
    ...
    let ctrl = $controller(ResourceQuotaDetailController, {resourceQuotaDetail: data});

    expect(ctrl.resourceQuotaDetail).toBe(data);
  }));
});
